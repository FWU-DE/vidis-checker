...
parser.add_argument('--input_name', type=str, required=True, help='Name of the input directory')
...
def process_tracking_pixels():
    issues = check_for_tracking_pixels(
        last_step_result
    )
...
def process_terms_of_use():
    ...
    result_processor_only = check_terms_of_use(terms_of_use_path, processor_only=True)
